...
struct MAP_ST_BONE : public D3DXFRAME
{
	D3DXMATRIXA16 CombinedTransformationMatrix;
};

struct MAP_ST_BONE_MESH : public D3DXMESHCONTAINER
{
...
class cMapAllocateHierarchy : public ID3DXAllocateHierarchy
{
protected:
	SYNTHESIZE(std::string, m_sFolder, Folder);

public:
	cMapAllocateHierarchy(void);
	~cMapAllocateHierarchy(void);
