...
texture Cart_A_01_MI; 
texture Map__12; 
texture Map__11; 

sampler2D Cart_A_01_MISampler = sampler_state  // TexCoord0 
{ 
   Texture = <Cart_A_01_MI>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__11Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__11>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( Cart_A_01_MISampler, vout.TexCoord0 ); 
